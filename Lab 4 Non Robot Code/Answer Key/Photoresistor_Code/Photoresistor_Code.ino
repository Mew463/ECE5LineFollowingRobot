...
void loop() {
  ReadPhotoResistors(); /**FIX ME: Which function should we call here to read photo resistors? **/ // Read photoresistors and map to 0-100 based on calibration

  Print(); /**FIX ME: Which function should we call here to print out our values? **/ // Print values to serial monitor
}
